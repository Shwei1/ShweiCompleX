 ...
 * @note Взагалі основна взаємодія відбувається саме з типом double, але можливість використовувати цілочисельні типи теж є.
 */
...
/**
* @brief Повертає комплексне число з оберненими дійсною та уявною частинами.
 ...
 * @return значення істиності порвівняння.
 */
