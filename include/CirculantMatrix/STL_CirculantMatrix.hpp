 ...
 */
        STL_CirculantMatrix(const std::vector<ComplexType>& A, const std::vector<ComplexType>& b);
 ...
 */
        STL_CirculantMatrix(const std::string& filename); //NOLINT
